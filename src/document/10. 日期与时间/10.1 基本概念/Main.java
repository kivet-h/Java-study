...
// =========================================================== 本地时间 ===========================================================
//当我们说当前时刻是2019年11月20日早上8:15的时候，我们说的实际上是本地时间。
// 在国内就是北京时间。在这个时刻，如果地球上不同地方的人们同时看一眼手表，他们各自的本地时间是不同的：
//如图[./本地时间.png]
...
// 我们国家实行过一段时间夏令时，1992年就废除了，但是矫情的美国人到现在还在使用，所以时间换算更加复杂。
//[./夏令时.png]
