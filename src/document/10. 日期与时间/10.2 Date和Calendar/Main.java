...
//public class Main {
//    public static void main(String[] args) {
//        System.out.println(System.currentTimeMillis()); // 1788874280973
//    }
//}
//$ java Main.java
//1788874280973
...
//        System.out.println(sdf.format(date)); // 2026-09-08 21:33:59
//    }
//}
//$ java Main.java
//2026-09-08 21:33:59
...
//        System.out.println(sdf.format(date)); // 周二 9月 08, 2026
//    }
//}
//$ java Main.java
//周二 9月 08, 2026
...
//上述代码在不同的语言环境会打印出类似Sun Sep 15, 2019这样的日期。中国可能是打印出类似：周二 9月 08, 2026
// 可以从JDK文档（https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/text/SimpleDateFormat.html）查看详细的格式说明。
...
//        System.out.println(y + "-" + m + "-" + d + " " + w + " " + hh + ":" + mm + ":" + ss + "." + ms); // 2026-9-8 3 21:36:56.311
//    }
//}
//$ java Main.java
//2026-9-8 3 21:36:56.311

//注意到Calendar获取年月日这些信息变成了get(int field)，返回的年份不必转换，返回的月份仍然要加1，
...
//}
//$ java Main.java
//java.util.GregorianCalendar[time=1788874678437,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id="Asia/Shanghai",offset=28800000,dstSavings=0,useDaylight=false,transitions=31,lastRule=null],firstDayOfWeek=2,minimalDaysInFirstWeek=1,ERA=1,YEAR=2026,MONTH=8,WEEK_OF_YEAR=37,WEEK_OF_MONTH=2,DAY_OF_MONTH=8,DAY_OF_YEAR=251,DAY_OF_WEEK=3,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=9,HOUR_OF_DAY=21,MINUTE=37,SECOND=58,MILLISECOND=437,ZONE_OFFSET=28800000,DST_OFFSET=0]
