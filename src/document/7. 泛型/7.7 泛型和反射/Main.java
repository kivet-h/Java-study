...
//}
//$ java Main.java
//Main.java:14: 错误: 已在方法 main(String[])中定义了变量 clazz
//Class<String> clazz = String.class;
//                      ^
//Main.java:15: 错误: 已在方法 main(String[])中定义了变量 str
//String str = clazz.newInstance();
//               ^
//Main.java:11: 警告: [deprecation] Class中的newInstance()已过时
//String str = (String) clazz.newInstance();
//                                   ^
//其中, T是类型变量:
//T扩展已在类 Class中声明的Object
//Main.java:15: 警告: [deprecation] Class中的newInstance()已过时
//String str = clazz.newInstance();
//                          ^
//其中, T是类型变量:
//T扩展已在类 Class中声明的Object
...
//注意：newInstance() 在 Java 9+ 中已被标记为 @Deprecated，所以上面代码会报错
...
// 因为这两个变量实际上指向同一个数组，所以，操作arr可能导致从ps获取元素时报错，
// 例如，以下代码演示了不安全地使用带泛型的数组：
//Pair[] arr = new Pair[2];
