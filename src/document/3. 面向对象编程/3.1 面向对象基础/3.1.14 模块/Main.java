...
//把一堆class封装为jar仅仅是一个打包的过程，而把一堆class封装为模块则不但需要打包，
// 还需要写入依赖关系，并且还可以包含二进制代码（通常是JNI扩展）。
...
// ================================================================== 编写模块 ==================================================================
//那么，我们应该如何编写模块呢？
// 还是以具体的例子来说。首先，创建模块和原有的创建Java项目是完全一样的，以oop-module工程为例，它的目录结构如下：
//oop-module
//├── bin
//├── build.sh
//└── src
...
// 然后，在--add-modules参数中指定了我们用到的3个模块java.base、java.xml和hello.world，用,分隔。
// 最后，在--output参数指定输出目录。
