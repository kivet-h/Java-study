...
//        String s = null;
//        int n = null; // 错误: 不兼容的类型: <空值>无法转换为int
//    }
//}
...
//        Integer n1 = new Integer(i);    // 警告: [deprecation] Integer中的Integer(int)已过时
...
//        System.out.println(ln); // 999
//
//        float f = num.floatValue();
//        System.out.println(f); // 999.0
//
//        double d = num.doubleValue();
//        System.out.println(d); // 999.0
//    }
//}
//$ java Main.java
//Main.java:249: 警告: [deprecation] Integer中的Integer(int)已过时
//Number num = new Integer(999);
//                     ^
//1 个警告
//-25
...
//    public static void main(String[] args) {
//        // 向上转型为Number:
//        Number num = Integer.valueOf(999); // 这种方式定义不会警告
//
//        // 获取byte, int, long, float, double:
//        byte b = num.byteValue();
//        System.out.println(b); // -25
