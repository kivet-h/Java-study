...
// 因为 Comparator<String> 接口定义的方法是 int compare(String, String) ，和静态方法 intcmp(String, String) 相比，除了方法名外，方法参数一致，返回类型相同，
...
//         }
//         System.out.println(persons); // [Person@5b464ce8, Person@57829d67, Person@19dfb72a]
//     }
// }
// class Person {
//     String name;
...
//         System.out.println(persons); // [Person:Bob, Person:Alice, Person:Tim]
//     }
// }
// class Person {
//     String name;
...
//         this.name = name;
//     }
//     // 在这里覆写 toString() 方法，使用println() 打印 Person 实例时，可以看到覆写后的格式，否则打印的是Person的引用地址
...
// 把泛型对应上就是方法签名 Person apply(String) ，即传入参数 String ，返回类型Person 。
