...
//此外，GET请求的参数必须附加在URL上，并以URLEncode方式编码，例如：http://www.example.com/?a=1&b=K%26R，参数分别是a=1和b=K&R。
...
//响应的第一行总是HTTP版本 响应代码 响应说明，例如，HTTP/1.1 200 OK表示版本是HTTP/1.1，响应代码是200，响应说明是OK。
...
//因为浏览器也是一种HTTP客户端，所以，客户端的HTTP编程，它的行为本质上和浏览器是一样的，即发送一个HTTP请求，接收服务器响应后，获得响应内容。
...
//content-length: 400408
//content-type: text/html
//date: Wed, 09 Sep 2026 13:59:09 GMT
//edge-copy-time: 1788962344227
//etag: "6aa165b0-5ca84"V=5965C31
//expires: Wed, 09 Sep 2026 14:00:03 GMT
//server: nginx
//vary: Accept-Encoding
//via: http/1.1 ctc.guangzhou.union.299 (ApacheTrafficServer/6.2.1 [cRs f ]), http/1.1 cmcc.chongqing.union.162 (ApacheTrafficServer/6.2.1 [cRs f ])
//x-cache: HIT.162
//x-powered-by: shci_v1.13
//x-via-cdn: f=sinaedge,s=cmcc.chongqing.union.150.nb.sinaedge.com,c=117.173.244.169;f=Edge,s=cmcc.chongqing.union.162,c=111.10.42.150
//x-via-edge: 1788962349027a9f4ad75cf2a0a6f0579c42a
//x-via-ssl: ssl.21.sinag1.hn1.lb.sinanode.com
//        <!DOCTYPE html>
//<!-- [ published at 2026-09-09 21:57:00 ] -->
//<html>
//<head>
...
//        <meta name="msapplication-TileCol...
