...
//    return p1.score > p2.score ? -1 : 1;
//}
//在p1.score和p2.score不相等的时候，它的返回值是正确的，
// 但是，在p1.score和p2.score相等的时候，它并没有返回0！
// 这就是为什么TreeMap工作不正常的原因：TreeMap在比较两个Key是否相等时，依赖Key的compareTo()方法或者Comparator.compare()方法。

// 在两个Key相等时，必须返回0。因此，修改代码如下：
//public int compare(Student p1, Student p2) {
