...
// 有一些错误是用户造成的，比如，希望用户输入一个 int 类型的年龄，但是用户的输入是abc：
// 假设用户输入了abc：
// String s = "abc";
...
// ============================================================= 捕获异常 =============================================================
// 捕获异常使用 try...catch 语句，把可能发生异常的代码放到 try {...} 中，然后使用 catch捕获对应的 Exception 及其子类：
...
// 意思是说，像 UnsupportedEncodingException 这样的CheckedException，必须被捕获。
...
// 我们也可以不捕获它，而是在方法定义处用throws表示toGBK() 方法可能会抛出 UnsupportedEncodingException ，就可以让 toGBK() 方法通过编译器检查：
// try...catch
// import java.io.UnsupportedEncodingException;
// import java.util.Arrays;
// public class Main {
