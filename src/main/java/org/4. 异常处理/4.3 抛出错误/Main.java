...
//at java.base/java.lang.Integer.parseInt(Integer.java:489)
...
//at Main.process1(Main.java:127)
...
//观察上面输出，新的异常已经丢失了原始异常信息，我们已经看不到原始异常NullPointerException的信息了。
...
//            process2();
//        } catch (NullPointerException e) {
//            throw new IllegalArgumentException(e); // <== 将原始的Exception实例传进去，新的Exception就可以持有原始Exception信息。
//        }
//    }
//
//    static void process2() {
...
//    at Main.process1(Main.java:162)
...
//    at Main.process2(Main.java:167)
//    at Main.process1(Main.java:160)
//    ... 6 more
...
//查看抛出的错误结果，这说明finally抛出异常后，原来在catch中准备抛出的异常就“消失”了，因为只能抛出一个异常。
