...
//
//        if (day.dayValue == 6 || day.dayValue == 0) {
//            System.out.println("Today is " + day + ". Work at home!"); // Today is 星期日. Work at home!
//        } else {
...
//上面代码，为什么System.out.println(day); 输出的是：星期日？
//答：System.out.println(Object) 依赖 toString()，使用时先调用对象的 toString() 方法获取字符串，再输出。而toString()被覆写了，所以输出的是星期日
