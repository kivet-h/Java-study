...
//}
//$ java Main.java
//Main.java:101: 错误: 未报告的异常错误ClassNotFoundException; 必须对其进行捕获或声明以便抛出
//Class cls = Class.forName("java.lang.String");
//                                 ^
//1 个错误
//错误: 编译失败

//报错了，根据错误提示，Class.forName() 方法声明了会抛出 受检异常 ClassNotFoundException，Java 强制要求你必须要么捕获它（try-catch），要么继续向上声明抛出。
