...
//举个栗子，对以下代码：
//public class Hello {
//    @Check(min=0, max=100, value=55) // 注解的配置参数可以有默认值，缺少某个配置参数时将使用默认值。
//    public int n;
//
//    @Check(value=99)
//    public int p;
//
//    @Check(99) // @Check(value=99) // 大部分注解会有一个名为value的配置参数，对此参数赋值，可以只写常量，相当于省略了value参数。
//    public int x;
//
//    @Check // 如果只写注解，相当于全部使用默认值。
//    public int y;
//}
